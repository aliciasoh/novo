// src/create/view-experiment.test.tsx
import { render, screen, waitFor } from '@testing-library/react';
import { vi } from 'vitest';
import { ViewExperiment } from './experiment-view'; // Adjust import path as needed
...
describe('ViewExperiment', () => {
  ...
  it('should render the experiment data in read-only mode', async () => {
    // Wait for experiment data to load from MSW
    await waitFor(() => {
    ...
    // Check form fields with experiment data
